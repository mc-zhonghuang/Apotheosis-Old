package cn.hackedmc.alexander.script;

import cn.hackedmc.alexander.Client;
import cn.hackedmc.alexander.script.api.*;
import cn.hackedmc.alexander.script.util.ScriptClassFilter;
...
public final class ScriptManager implements InstanceAccess {
    ...
    public void init() {
        ...
        this.globalBindings = new SimpleBindings() {{
            ...
            this.put("alexander", new RiseAPI());
