package cn.hackedmc.alexander.util.shader;
...
public class ShaderUtil implements InstanceAccess {
    ...
    public static String getShaderResource(final String resource) {
        try {
            final InputStream inputStream = RESOURCE_MANAGER.getResource(new ResourceLocation("alexander/shader/" + resource)).getInputStream();
