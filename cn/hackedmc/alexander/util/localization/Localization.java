package cn.hackedmc.alexander.util.localization;
...
public class Localization {
     ...
     * located in alexander/text
     */
    @SneakyThrows
    public static void populate() {
        for (Locale locale : Locale.values()) {
            ResourceLocation resourceLocation = new ResourceLocation("alexander/text/" + locale.getFile() + ".properties");
