package cn.hackedmc.alexander.ui.menu.impl.intro;

import cn.hackedmc.alexander.Client;
import cn.hackedmc.alexander.ui.menu.impl.main.LoginMenu;
...
public class PrereleaseDisclaimer extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontManager.getProductSansRegular(16).drawCenteredString("© Alexander Client 2023. All Rights Reserved", sr.getScaledWidth() / 2D,
