package cn.hackedmc.alexander.ui.click.clover;

import cn.hackedmc.alexander.Client;
import cn.hackedmc.alexander.newevent.Listener;
import cn.hackedmc.alexander.newevent.annotations.EventLink;
import cn.hackedmc.alexander.ui.click.clover.button.impl.ModuleButton;
import cn.hackedmc.alexander.ui.click.clover.button.impl.OptionsButton;
import cn.hackedmc.alexander.ui.click.clover.setting.api.SettingComp;
import cn.hackedmc.alexander.util.dragging.Drag;
import cn.hackedmc.alexander.util.gui.ScrollUtil;
import cn.hackedmc.alexander.util.gui.textbox.TextAlign;
import cn.hackedmc.alexander.util.gui.textbox.TextBox;
...
//            FontManager.getIconsThree(12).drawString("U", searchPosition.x + 6, searchPosition.y + 8, ColorUtil.withAlpha(Color.WHITE, 70).hashCode());
            ...
            InstanceAccess.NORMAL_POST_BLOOM_RUNNABLES.add(() -> FontManager.getNunito(160).drawString("?", logo.x, logo.y, Color.WHITE.hashCode()));
        ...
        InstanceAccess.NORMAL_BLUR_RUNNABLES.add(() -> RenderUtil.roundedRectangle(drag.position.x, drag.position.y, scale.x, scale.y, round, Color.BLACK));
