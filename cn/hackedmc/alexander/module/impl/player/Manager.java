...
import cn.hackedmc.alexander.component.impl.player.SelectorDetectionComponent;
...
import cn.hackedmc.alexander.util.player.ItemUtil;
        ...
        for (int i = 0; i < INVENTORY_SLOTS; i++) {
            ...
            if (item instanceof ItemPotion) {
                if (potion == -1) {
                    ...
                    final ItemStack currentStack = InstanceAccess.mc.thePlayer.inventory.getStackInSlot(potion);
                    ...
                    for (final PotionEffect e : InstanceAccess.mc.thePlayer.getActivePotionEffects()) {
