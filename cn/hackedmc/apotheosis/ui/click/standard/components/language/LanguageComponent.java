package cn.hackedmc.apotheosis.ui.click.standard.components.language;
...
public class LanguageComponent implements InstanceAccess {
    ...
    public void draw(double y) {
        ...
        // Draw flag
        RenderUtil.image(new ResourceLocation("apotheosis/icons/language/" + locale.getFile() + ".png"),
