package cn.hackedmc.apotheosis.script;

import cn.hackedmc.apotheosis.Client;
import cn.hackedmc.apotheosis.script.api.*;
import cn.hackedmc.apotheosis.script.util.ScriptClassFilter;
...
public final class ScriptManager implements InstanceAccess {
    ...
    public void init() {
        ...
        this.globalBindings = new SimpleBindings() {{
            ...
            this.put("apotheosis", new RiseAPI());
