package cn.hackedmc.apotheosis.util.font;

import cn.hackedmc.apotheosis.util.font.impl.rise.FontRenderer;
import cn.hackedmc.apotheosis.util.font.impl.rise.FontUtil;
...
public class FontManager {
    ...
    private static Font get(HashMap<Integer, FontRenderer> map, int size, String name, boolean fractionalMetrics, boolean AA, boolean otf, boolean international) {
        if (!map.containsKey(size)) {
            final java.awt.Font font = FontUtil.getResource("apotheosis/font/" + name + (otf ? ".otf" : ".ttf"), size);
